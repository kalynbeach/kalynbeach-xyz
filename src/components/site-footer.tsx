...
export default function SiteFooter() {
  ...
  return (
    <footer className="w-full h-48 md:h-36 mx-auto my-0 px-8 md:px-4 flex flex-col md:flex-row gap-8 justify-center md:justify-between items-start md:items-center">
